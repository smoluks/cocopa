...
export abstract class Parser {
   ...
   * @param infoParser
   */
  constructor(match: (string | RegExp)[], dontMatch: (string | RegExp)[], infoParser?: BuiltInInfoParser | undefined) {
    this._match = match;
  ...
  public match(line: string): Result | undefined {
    ...
    if (this._infoParser && this._infoParser.enabled && res && res.compiler.length) {
