 ...
 * 
 */
export function makeSpawnSyncSpy(stimulusFile: string)
{
    /*
     ...
     */
    const _spawnSyncMock = (command: string,
    ...
    const spawnSyncSpy = jest.spyOn(cp, 'spawnSync').mockImplementation(spawnSyncMock);
