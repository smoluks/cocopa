...
import { CCppPropertiesISMode, CCppPropertiesCStandard, CCppPropertiesCppStandard } from './CCppPropertiesConfiguration';
...
export class CCppPropertiesContentResult extends CCppPropertiesContent
{
    ...
    {
        const c = new CCppPropertiesConfigurationResult(result,
                                                        name,
                                                        isMode,
                                                        cStandard,
                                                        cppStandard,
